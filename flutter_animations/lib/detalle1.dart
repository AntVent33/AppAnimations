...
class detalle1Page extends StatefulWidget {
  const detalle1Page({Key? key}) : super(key: key);

  @override
  _detalle1Page createState() => _detalle1Page();
}

class _detalle1Page extends State<detalle1Page> {
