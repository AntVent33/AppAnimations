...
class detalle9Page extends StatefulWidget {
  const detalle9Page({Key? key}) : super(key: key);

  @override
  _detalle9Page createState() => _detalle9Page();
}

class _detalle9Page extends State<detalle9Page> {
