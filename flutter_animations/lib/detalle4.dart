...
class detalle4Page extends StatefulWidget {
  const detalle4Page({Key? key}) : super(key: key);

  @override
  _detalle4Page createState() => _detalle4Page();
}

class _detalle4Page extends State<detalle4Page> {
