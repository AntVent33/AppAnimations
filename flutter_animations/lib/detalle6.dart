...
class detalle6Page extends StatefulWidget {
  const detalle6Page({Key? key}) : super(key: key);

  @override
  _detalle6Page createState() => _detalle6Page();
}

class _detalle6Page extends State<detalle6Page> {
